        ...
        >
          ...
          <motion.div variants={fadeIn} className="flex flex-wrap justify-center gap-4">
            {pData.socials?.linkedIn && (
              <a href={pData.socials.linkedIn} target="_blank" rel="noreferrer" className="p-3 bg-zinc-900 hover:bg-blue-600 rounded-full transition-colors duration-300">
            ...
            {pData.socials?.github && (
              <a href={pData.socials.github} target="_blank" rel="noreferrer" className="p-3 bg-zinc-900 hover:bg-zinc-700 rounded-full transition-colors duration-300">
            ...
            {pData.socials?.x && (
              <a href={pData.socials.x} target="_blank" rel="noreferrer" className="p-3 bg-zinc-900 hover:bg-zinc-700 rounded-full transition-colors duration-300">
